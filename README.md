...
# Learning Paths and Workshops 
The learning paths we are offering in this bootcamp are aligned with the Microsoft AI Personas and certifications. 
> If you don’t have any experience: no worries, we have preparation material for you. 
...
Feedback and contributions are welcomed to this content as we can improve and build on for the whole AI community.

* If you are having trouble with any of the content - please [submit an issue](https://help.github.com/en/articles/creating-an-issue) on the specific repository provided

* If you have more general feedback or issues with all the content provided, please [submit an issue](https://help.github.com/en/articles/creating-an-issue) on this repository

* If you have fixed any issues on the content please [submit a pull request](https://help.github.com/en/articles/creating-a-pull-request) and it will be reviewed by the team

* If you are creating your own content you wish to share please get in touch with the Global AI Community team.
